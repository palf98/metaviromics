...
3) virfinder2fasta.py parses the postprocessed file and selects contigs with  FDR < 0.05 or 30% lowest p-values (separate outputs) from the complete fasta file.
